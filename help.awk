...
# This file came from
# https://github.com/yasunori0418/dotfiles?tab=License-1-ov-file#readme
# NYSL License https://www.kmonos.net/nysl/index.en.html


function cmd_accent(char) {
  # accent = start front_cyan accent_bold end
  accent = start front_cyan end
...
BEGIN {
  ...
  line_accent = start back_black end padding_32 reset
}
